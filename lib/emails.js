...
export function buyerReceipt({ squares, amount, reference, canReply }) {
  ...
  const shareText = `I've just claimed my ${noun} on the Hout Bay United Legacy 500 shirt. 500 squares, R2,000 each, and the whole R1,000,000 goes to the players. Claim yours: ${url}`;
