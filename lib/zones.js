...
export const ZONES = [
  ...
  // drift even when the exclusion shape changes.
  {
    ...
    exclude: [
      ...
      // The artwork covers 74 cells but the total has to land on exactly 80 for
      // the campaign to come to 500, so 6 cells directly under the wordmark are
      // held back. Plain fabric, deliberately sacrificed to the arithmetic.
