...
export const ZONES = [
  ...
  // above and below the old, shorter box. Exclusions are now precise per
  // element (heart / crest / wordmark) instead of one blanket rectangle, so
  // the open gap between the heart and crest is claimable. A same-size
  // buffer row (r12, cols 0-6) is excluded to compensate, keeping usable
  // count at exactly 150 - the campaign is "Rainbow 500" (150 front + 350
  // back = 500 squares at R2,000 = R1,000,000), so this total must not
  // drift even when the exclusion shape changes.
  {
    ...
    exclude: [
      { c0: 1, c1: 2, r0: 2, r1: 6 }, // heart icon
      { c0: 5, c1: 9, r0: 1, r1: 6 }, // HBUFC crest
      { c0: 0, c1: 9, r0: 6, r1: 11 }, // "the goal is love" wordmark
      { c0: 0, c1: 6, r0: 12, r1: 12 }, // buffer row - keeps usable count at 150
    ],
  },
  {
    id: "front-sleeveL",
